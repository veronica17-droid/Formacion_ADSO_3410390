...
void main(List<String> args) {
  ...
  if (tieneCarnet == true && edad >= 18) {
    stdout.write("Bienvenido al centro de formación");
  } else {
    stdout.write("No se cumple con los requisitos de acceso");
  }
  ...
  // ignore: dead_code
  if (!sistemaCaido){
    stdout.write("El sistema no está caido");
  } else {
    stdout.write("El sistema está caido");
  }
